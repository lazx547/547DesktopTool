...
Item {//彩蛋
    ...
    function creata_shells(){//创造炮弹
        //本体
        var image = Qt.createQmlObject("import QtQuick 2.14; Image { source: './i/shells.png'; width: 9; height: 14.5}", item_play_back_q);
    ...
    function create_bullet(v){//创造单个子弹
        var image = Qt.createQmlObject("import QtQuick 2.14; Image { source: './i/bullet.png'; width: 5; height: 12}", item_play_back_q);
        image.x = tank.x+(tank.width+image.width)/3.0+3-item_play_back_q.x
        image.y =tank.y+(tank.height+image.height)/3.0+2-item_play_back_q.y
        image.rotation=(tank.rotation+tank_top.rotation)%360
        var rotation=(image.rotation-90)*Math.PI/180.0
    ...
    function create_blast_large(x,y,ptr){//创造爆炸特效 大型
        var image = Qt.createQmlObject("import QtQuick 2.12; Image { source: './i/explo/1_1.png'; width: 50; height: 50}", ptr);
        image.x = x-20.5
        image.y = y-17.75
        image.rotation=0
        ...
        timer.triggered.connect(function()
        {
            ...
            {
            case 2:
                image.source="./i/explo/1_2.png";
                break
            case 3:
                image.source="./i/explo/1_3.png";
                break
            case 4:
                image.source="./i/explo/1_4.png";
                break
            case 5:
                image.source="./i/explo/1_5.png";
                break
            case 6:
                image.source="./i/explo/1_6.png";
                break
            case 7:
                image.source="./i/explo/1_7.png";
                break
            case 8:
                image.source="./i/explo/1_8.png";
                break
            case 9:
                image.source="./i/explo/1_9.png";
                break
            case 10:
                image.source="./i/explo/1_9_1.png";
                break
            case 11:
                image.source="./i/explo/1_9_2.png";
                break
            case 12:
                image.source="./i/explo/1_9_3.png";
                break
            case 13:
                image.source="./i/explo/1_9_4.png";
                break
            default:
                timer.stop();
                image.destroy()
    ...
    function create_blast_small(x,y){//创造爆炸特效 小型
        var image = Qt.createQmlObject("import QtQuick 2.14; Image { source: './i/explo/2_1.png'; width: 30; height: 30}", item_play_back_q);
        image.x = x-12.5
        image.y = y-9
        image.rotation=0
        ...
        timer.triggered.connect(function()
        {
            ...
            {
            case 2:
                image.source="./i/explo/2_2.png";
                break
            case 3:
                image.source="./i/explo/2_3.png";
                break
            case 4:
                image.source="./i/explo/2_4.png";
                break
            case 5:
                image.source="./i/explo/2_5.png";
                break
            case 6:
                image.source="./i/explo/2_6.png";
                break
            case 7:
                image.source="./i/explo/2_7.png";
                break
            case 8:
                image.source="./i/explo/2_8.png";
                break
            case 9:
                image.source="./i/explo/2_9.png";
                break
            case 10:
                image.source="./i/explo/2_9_1.png";
                break
            case 11:
                image.source="./i/explo/2_9_2.png";
                break
            case 12:
                image.source="./i/explo/2_9_3.png";
                break
            case 13:
                image.source="./i/explo/2_9_4.png";
                break
            default:
                timer.stop();
                image.destroy()
    ...
    function create_shockwave(x,y,ptr1,ptr2){//创造冲击波
        var image = Qt.createQmlObject("import QtQuick 2.14; Image { source: './i/shoge.png'; width: 10; height: 10}", ptr2);
        ...
        onTriggered:{
            ...
            if(r)
            {
                ...
                if(bu_ammunition_switch_q.type)
                {
                    ...
                    bu_ammunition_switch_q.source="./i/but/bullet.svg"
                }
                else
                {
                    bu_ammunition_switch_q.type=true
                    bu_ammunition_switch_q.source="./i/but/shells.svg"
                }
            }
            //炮塔转向
            if(issh==0)
            ...
            {
                spase=false;
                bu_space_q.source="./i/but/space_.svg"
                bu_q_q.source="./i/but/q_.svg"
                bu_e_q.source="./i/but/e_.svg"
                if(bu_ammunition_switch_q.type)
                {
                    charge_time=150;
                    creata_shells()
            ...
            {
                bu_space_q.source="./i/but/space.svg"
            }
            file_q.source=file_q_source+"/x.ff"
                ...
                Timer {
                    ...
                    onTriggered:{
                        ...
                        case 18:
                            ...
                            break
                        default:
                            bu_q_q.source="./i/but/q.svg"
                            bu_e_q.source="./i/but/e.svg"
                            di=0.5
                            ii=0
                            tit.stop()
                            issh=0
                ...
                Timer {
                    ...
                    onTriggered:{
                        ...
                        case 5:
                            fit.ty=6
                            fir.visible=true
                            fir.source="./i/explo/3_1.png"
                            break
                        case 6:
                            fit.ty=7
                            fir.source="./i/explo/3_2.png"
                            break
                        case 7:
                            fit.ty=8
                            fir.source="./i/explo/3_3.png"
                            break
                        case 8:
                            fit.ty=9
                            fir.source="./i/explo/3_4.png"
                            break
                        default:
                            fit.ty=0
                            fir.visible=false
        ...
        Item {//操控按钮
            ...
            Image {//射击按钮
                ...
                MouseArea {
                    ...
                    z: 1
                    onPressed: {
                        if(bu_space_q.source=="./i/but/space.svg")
                        {
                            spase=true
                            bu_space_q.source="./i/but/space_.svg"
                        }
    ...
    Item {//设置界面
        ...
        Image {//显示设置按钮设置按钮
            ...
            MouseArea {
                ...
                z: 1
                onClicked:{
                        if(set_bu_show_q.source=="./i/but/yes.png")
                        {
                            create_blast_large(275.5,56.5,item_setting_q)
                            set_bu_show_q.source="./i/but/noo.png"
                            bu_control_q.visible=false
                        }
                        else
                        {
                            set_bu_show_q.source="./i/but/yes.png"
